    ...
    <section class="modules carousel text-center">
        ...
        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="item active" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/background-1.jpg'); background-attachment: fixed; background-position: center center;">
                ...
                <div class="item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/background-2.jpg'); background-attachment: fixed; background-position: center center;">
                    <div class="overlay"></div>
                    <div class="carousel-caption">
                ...
                <div class="item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/background-3.jpg'); background-attachment: fixed; background-position: center center;">
                    <div class="overlay"></div>
                    <div class="carousel-caption">
                ...
                <div class="row">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="main_container">
                            ...
                            <div class="col-md-7">
								<label class="plane-label"><i class="fa fa-send"></i></label>
            ...
            <div class="row text-center">
                <div class="col-md-12">
                    <div class="more_btns_area">
                        ...
                        <a href="<?php echo get_home_url();?>/guest-post" class="more_item_btn">View All Posts <i class="fa fa-angle-right"></i></a>
                    </div>
